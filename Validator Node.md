# Hướng Dẫn Cài Đặt Validator Node cho 0gchaind
...
### Hệ Điều Hành: Linux amd64 arm64 (Hướng dẫn này sử dụng Ubuntu 22.04 LTS)
...
0gchaind config keyring-backend os # Có thể đặt là "test" để không yêu cầu mật khẩu
```
### Bước 6: Download Genesis File
```
wget https://github.com/0glabs/0g-chain/releases/download/v0.1.0/genesis.json -O $HOME/.0gchain/config/genesis.json
```
### Bước 7: Thêm Seeds và Peers vào Config
```
SEEDS="c4d619f6088cb0b24b4ab43a0510bf9251ab5d7f@54.241.167.190:26656,44d11d4ba92a01b520923f51632d2450984d5886@54.176.175.48:26656,f2693dd86766b5bf8fd6ab87e2e970d564d20aff@54.193.250.204:26656,f878d40c538c8c23653a5b70f615f8dccec6fb9f@54.215.187.94:26656" && \
sed -i.bak -e "s/^seeds *=.*/seeds = \"${SEEDS}\"/" $HOME/.0gchain/config/config.toml
```
### Bước 8: Thay Đổi Ports (Tùy Chọn)
```
...
```
### Bước 9: Cấu Hình Pruning để Tiết Kiệm Dung Lượng Lưu Trữ (Tùy Chọn)
```
sed -i \
    ...
    "$HOME/.0gchain/config/app.toml"
```
### Bước 10: Cài Đặt Min Gas Price
```
sed -i "s/^minimum-gas-prices *=.*/minimum-gas-prices = \"0ua0gi\"/" $HOME/.0gchain/config/app.toml
```
### Bước 11: Enable Indexer (Tùy Chọn)
```
sed -i "s/^indexer *=.*/indexer = \"kv\"/" $HOME/.0gchain/config/config.toml
```
### Bước 12: Tạo Service File
```
...
```
### Bước 15: Lấy HEX Address để Faucet Token
```
echo "0x$(0gchaind debug addr $(0gchaind keys show $WALLET_NAME -a) | grep hex | awk '{print $3}')"
```
### Bước 16: Faucet Tokens
### Bước 17: Kiểm Tra Balance
Đảm bảo rằng node của bạn đã sync xong (catching_up trả về false).
...
```
### 5. Move file priv_validator_state.json trở lại
```
